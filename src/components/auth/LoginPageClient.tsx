          ...
          <div className="grid w-full gap-10 lg:grid-cols-[minmax(0,1.18fr)_minmax(360px,440px)] lg:items-center">
            <section className="order-2 space-y-6 lg:order-1 lg:pr-6">
              <div className="space-y-3">
                ...
                <h1 className="text-[1.7rem] font-bold tracking-tight sm:text-[1.95rem] lg:text-[2.05rem]">
              ...
              <div className="w-full max-w-md rounded-xl border bg-[var(--card)] p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <form className="space-y-3" onSubmit={handlePasswordSignIn}>
                    ...
                    <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-700 dark:border-amber-800/40 dark:bg-amber-900/20 dark:text-amber-400">
                      <Info className="mt-0.5 h-3.5 w-3.5 shrink-0" />
                      <span>
                        초대 또는 관리자가 생성한 계정의 초기 비밀번호는{' '}
                        <span className="font-mono font-semibold">qwer1234</span>입니다. 로그인 후 변경하도록 안내됩니다.
                      </span>
                    </div>
