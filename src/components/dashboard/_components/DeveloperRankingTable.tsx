 ...
 */
export function DeveloperRankingTable({ className, data, defaultSortKey }: DeveloperRankingTableProps) {
  const router = useRouter();
  const { start } = useLoadingBar();
  const [sortKey, setSortKey] = useState<SortKey>(defaultSortKey ?? 'compositeScore');
